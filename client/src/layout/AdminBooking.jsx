...
const AdminBooking = () => {
  ...
  return (
    <div className="admin-booking-container bg-gray-50 min-h-screen p-6">
      <h1 className="text-3xl font-semibold text-center mb-6 text-gray-800">Booking Details</h1>
      {loading ? (
        <DotLottieReact
        ...
        <div className="overflow-x-auto">
          <table className="min-w-full table-auto border-collapse border border-gray-300 shadow-md rounded-lg bg-white">
