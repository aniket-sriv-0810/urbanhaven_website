     ...
     <div className="mt-12 px-6 lg:px-20">
      ...
      <ul className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
        {[
          ...
          <li
            key={index}
            className="flex flex-col items-center text-center p-6 bg-white shadow-md rounded-xl hover:shadow-2xl transition-transform transform hover:scale-105 duration-300"
          >
