...
const SearchBar = ({ setHotels }) => {
 ...
 useEffect(() => {
  ...
  return (
<div className={`flex flex-wrap items-center justify-center gap-4 w-full max-w-3xl mx-auto p-6 rounded-2xl bg-white/20 backdrop-blur-xl shadow-xl border border-gray-400 transition-all duration-300 hover:shadow-2xl ${status.length > 0 ? " border-red-500" : null}`} data-aos="fade-down">
