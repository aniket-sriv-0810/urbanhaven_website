   ...
   <Navbar/>
    ...
    <section className="bg-gradient-to-b from-gray-100 to-gray-50 text-gray-900">
      <div className="">
        ...
        <h1 className="text-2xl p-5 font-bold text-center mt-5 text-orange-500 animate-fadeInUp">
          Discover UrbanHaven Hotels
        </h1>
        <img
              src={Logo}
              alt="Our Logo"
              className="w-28 h-28 mt-4 bg-gray-100 rounded-full shadow-lg shadow-gray-600  object-cover transform hover:scale-105 transition duration-500"
            />
            </span>
        <p className="text-base text-center p-5 text-gray-600 mb-12 leading-relaxed max-w-3xl ">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center mt-16">
          <div className="flex flex-col justify-center order-2 md:order-1">
            ...
            <ul className="text-base flex flex-col gap-3  p-5 text-gray-600 mb-12 leading-relaxed max-w-3xl">
