...
const LoginLoader = () => {
  ...
  return (
    ...
    {isLoading ?
        ...
        className=''
        />
       <span className='text-center text-2xl font-bold text-[#6de28f] animate-pulse relative sm:-top-[20%] sm:text-4xl lg:-top-[20%] lg:text-5xl'>Registered Successfully</span>
  </div>
  </>
  : null
}
