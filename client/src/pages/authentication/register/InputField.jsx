...
const InputField = ({ Icon, type, name, placeholder, value, onChange, error, inputRef }) => {
    const inputStyling =
    'w-full border border-gray-300 rounded-xl p-2  focus:outline-none focus:ring-2 focus:ring-green-200 bg-[#5454544f] placeholder:text-center placeholder:lowercase placeholder:text-white placeholder:text-sm placeholder:text-gray-300  valid:border-2 caret-green-500  ';
  return (
